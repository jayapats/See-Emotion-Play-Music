...
import com.spotify.faceapi.service.RecentlyPlayedTrackService;
...
public class RecentlyPlayedTrackServiceTest {

    @InjectMocks
    private RecentlyPlayedTrackService recentlyPlayed;
    ...
    public void getTopTracks_Success() throws Exception {
        ...
        LinkedHashMap res = (LinkedHashMap) recentlyPlayed.getHistory("AEQ1099");
    ...
    public void getTopTracks_NoContent() throws Exception {
        ...
        Mockito.when(restTemplate.exchange(ArgumentMatchers.anyString(),
            ...
            LinkedHashMap result = (LinkedHashMap) recentlyPlayed.getHistory("AEQ1099");

        Assert.assertEquals(inputMap, result);
    }
    ...
    public void getTopTracks_Forbidden() {
        ...
        String Message = null;
        try{
            recentlyPlayed.getHistory("AEQ1099");
        }catch (Exception e){
